...
class NotificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notification" do
    assert_difference("Notification.count") do
      post notifications_url, params: { notification: { body: @notification.body, status: @notification.status, title: @notification.title } }
    end
  ...
  test "should update notification" do
    patch notification_url(@notification), params: { notification: { body: @notification.body, status: @notification.status, title: @notification.title } }
